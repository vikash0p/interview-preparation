...
import JavaScriptLogicalNavigation from '../mockInterviewComponents/javascript-mock-components/JavaScriptLogicalNavigation';
import JavaScriptMockNavigation from '../mockInterviewComponents/javascript-mock-components/JavascriptMockNavigation';
			...
			<div className='w-full max-w-3xl mx-auto'>
				{accordionData.map((item, index) => (
					<div key={index} className='border-b border-b-gray-200'>
						{/* Sticky Title */}
						<div
							className='flex justify-between items-center bg-gray-950 py-4 px-2 cursor-pointer hover:bg-gray-700 transition-transform duration-300 sticky top-0 z-10'
