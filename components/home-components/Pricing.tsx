		...
		<section id='pricing' className='py-20 bg-neutral-900'>
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8' id='el-me01x7c0'>
				<div className='text-center mb-16' id='el-n3f52mou'>
					<h2
						className='text-4xl font-bold text-white mb-4 animate__animated animate__fadeIn'
						id='el-7pi58vb5'
					>
						Pricing Plans
					</h2>
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-8' id='el-hrv3or9j'>
					...
					>
						<div className='text-center mb-8' id='el-w0qqlofw'>
							...
							<div
								className='flex justify-center items-baseline mb-4'
								id='el-ez3ygf1g'
							>
								<span
					...
					>
						...
						>
							<span
								className='bg-indigo-500 text-white px-4 py-1 rounded-full text-sm font-semibold'
								id='el-ldtp4o3b'
							>
								Most Popular
							</span>
