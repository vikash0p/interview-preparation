...
const SlugDiscussion = () => {
	const [comments, setComments] = useState([
			...
			replies: [
				{
					...
					content:
						'Glad it helped! For more advanced validation, you might want to look into react-hook-form.',
					likes: 3,
					liked: false,
				},
			],
		},
		{
			...
			content:
				"Has anyone tried implementing this with TypeScript? I'm having trouble with the form state types.",
			likes: 4,
			liked: true,
			replies: [],
		},
		...
		<div className='bg-gray-900 text-gray-100 p-6 rounded-sm'>
				...
				<div className='flex gap-3 mb-3'>
					...
					<div className='flex-1'>
						...
						<p className='text-sm text-gray-400'>
							Share your thoughts about this solution
						</p>
					</div>
				</div>
			...
			<div className='space-y-6'>
				{comments.map((comment) => (
					<div
						key={comment.id}
						className='bg-gray-800/30 rounded-sm border border-gray-700 p-4'
					>
						{/* Comment Header */}
						<div className='flex gap-3 mb-3'>
