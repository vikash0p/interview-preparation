  ...
  const [comments, setComments] = useState([
    {
      ...
      content: 'This solution helped me understand controlled forms better! The validation part was particularly insightful.',
      likes: 8,
      liked: false,
      replies: [
        {
    ...
    <div className="bg-gray-900 text-gray-100 p-6 rounded-xl">
      ...
      <div className="mb-8 bg-gray-800/50 p-4 rounded-xl border border-gray-700">
        ...
        <textarea
          ...
          className="w-full bg-gray-800 border border-gray-700 rounded-lg p-4 text-gray-200 mb-3 min-h-[100px] focus:outline-none focus:ring-2 focus:ring-indigo-500"
        />
        ...
        <div className="flex justify-end">
          <button
            ...
            className="px-5 py-2 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg flex items-center gap-2"
          >
            <FaRegPaperPlane />
            Post Comment
          </button>
      ...
      <div className="space-y-6">
        {comments.map((comment) => (
          <div key={comment.id} className="bg-gray-800/30 rounded-xl border border-gray-700 p-4">
            {/* Comment Header */}
            <div className="flex gap-3 mb-3">
              <div className="bg-gray-700 border-2 border-dashed rounded-xl w-12 h-12 flex items-center justify-center">
            ...
            {editingComment === comment.id ? (
              <div className="mb-3">
                <textarea
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg p-3 text-gray-200 mb-2 min-h-[100px] focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
            ...
            <div className="flex justify-between">
              ...
              <div className="relative group">
                ...
                <div className="absolute right-0 mt-1 w-40 bg-gray-800 border border-gray-700 rounded-lg shadow-lg py-2 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-opacity z-10">
                  <button
            ...
            {replyingTo === comment.id && (
              <div className="mt-4 pl-4 border-l-2 border-gray-700">
                <textarea
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg p-3 text-gray-200 mb-2 min-h-[80px] focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
                <div className="flex gap-2">
                  <button
                    onClick={() => handleAddReply(comment.id)}
                    disabled={!replyContent.trim()}
                    className="px-3 py-1 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg text-sm"
                  >
                    Post Reply
                  </button>
                  <button
                ...
                {comment.replies.map((reply) => (
                  <div key={reply.id} className="pt-4">
                    <div className="flex gap-3 mb-2">
                      <div className="bg-gray-700 border-2 border-dashed rounded-xl w-10 h-10 flex items-center justify-center">
