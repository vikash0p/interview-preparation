	...
	return (
		<Link href={link} aria-label={title}>
			<motion.div
				...
				whileHover='hover'
				whileTap='tap'
				className='group relative p-4 sm:p-5 md:p-6 rounded-xl border-2 border-gray-700 bg-gray-800 shadow-2xl hover:border-indigo-500 transition-colors cursor-pointer'
				style={{
					background:
			...
			>
				...
				<div className='absolute inset-0 bg-gradient-to-br from-indigo-500/20 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity rounded-xl pointer-events-none' />

				{/* Icon */}
				<motion.div
					className='w-12 h-12 sm:w-14 sm:h-14 bg-black/30 rounded-lg flex items-center justify-center mb-4'
