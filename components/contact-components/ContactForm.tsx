...
const ContactForm: React.FC<ContactFormProps> = ({ formData, setFormData, submitted, isLoading, handleSubmit }) => {
  ...
  return (
    ...
    >
      ...
      {submitted ? (
        <motion.div initial={{ scale: 0.5 }} animate={{ scale: 1 }} className="text-center py-12 space-y-4">
          <FaCheckCircle className="text-6xl text-green-500 mx-auto" />
          <h3 className="text-3xl font-bold">Message Sent!</h3>
          <p className="text-gray-300">Thank you for contacting us. We&apos;ll respond within 24 hours.</p>
        </motion.div>
      ) : (
