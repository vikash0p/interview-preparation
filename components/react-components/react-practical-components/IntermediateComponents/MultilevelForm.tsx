    ...
    <div>
      <div className="flex flex-col gap-5 justify-center items-center ">
        <form
          ...
          className="flex flex-col gap-5 items-center w-96 h-60  justify-center bg-gray-900 rounded-md mt-5 "
        >
          {index > 0 && (
            <button
              type="button"
          ...
          <button
            type="submit"
            className="w-32 px-5 py-2 bg-indigo-600 text-white rounded-sm"
          >
