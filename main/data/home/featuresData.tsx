...
export const featuresData: IFeature[] = [
	...
	},
	{
		...
		title: 'AI Interview',
		description:
			'Experience real-time AI-driven interviews tailored to your role and level.',
	...
	},
	{
		...
		description:
			'Hands-on coding scenarios designed to simulate real-world technical interview tasks.',
