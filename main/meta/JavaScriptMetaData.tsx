...
export const JavaScriptMetaData: Metadata = {
	...
	description:'Crack JavaScript interviews with confidence. Practice technical questions, coding challenges, and get personalized AI feedback tailored to your skill level.',
	...
	openGraph: {
		title: 'JavaScript Interview Preparation',
		description:'Sharpen your JavaScript skills with our AI-driven platform. Real-world questions, live coding practice, and expert feedback to help you land your next job.',
		url: `${url}/Javascript`,
