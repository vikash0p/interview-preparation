...
const ReactInterviewQuestionLayout = ({
  ...
  return (
    <div className="w-full min-h-screen lg:flex lg:pl-1/4">
      {/* Sidebar */}
      <div className="lg:w-1/4 h-screen fixed top-20 left-0 bg-zinc-900 py-5 overflow-y-scroll custom-scrollbar">
      ...
      {/* Main Content */}
      <div className="lg:w-3/4 ml-auto p-5 lg:pl-8 bg-gradient-to-b from-gray-900 to-gray-900 ">
        {children}
      </div>
    </div>
  );
