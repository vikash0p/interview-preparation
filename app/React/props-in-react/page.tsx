  ...
  return (
    <div>
      ...
      <p>
        ...
        one component to another, specifically from a parent component to a
        child component. Props are read-only, meaning they cannot be modified by
        the child component; they are used to display dynamic content or make
        components reusable.
      </p>
      <div className="mt-10">
      ...
      <ul className="list-disc list-inside mt-5 mb-6 space-y-2">
        <li>Props are passed down from the parent component to the child component.</li>
        <li>Props are immutable, meaning the child component cannot change them.</li>
