...
import { FaExclamationTriangle, FaHome, FaSearch, FaBook, FaEnvelope } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white px-4 flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className="space-y-6">
          ...
          >
            The technical interview resource you&apos;re looking for doesn`&apos;t exist or has been moved. Don`&apos;t
            worry - we`&apos;ve got plenty of other materials to help you prepare!
          </motion.p>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-400">Back to the main dashboard</p>
                  </div>
                </div>
              </motion.div>
            </Link>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-400">Explore all interview questions</p>
                  </div>
                </div>
              </motion.div>
            </Link>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-400">View learning materials</p>
                  </div>
                </div>
              </motion.div>
            </Link>
      ...
      >
        <p>Interview Prep Platform • Helping developers succeed in technical interviews since 2023</p>
      </motion.div>
    </div>
  );
}
